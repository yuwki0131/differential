...
/* package differential-0.1.0.0 */
#define VERSION_differential "0.1.0.0"
#define MIN_VERSION_differential(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "differential-0.1.0.0-4oXEmZGNO6n8VWLt7jyCUO"

#define CURRENT_PACKAGE_KEY "differential-0.1.0.0-4oXEmZGNO6n8VWLt7jyCUO"
